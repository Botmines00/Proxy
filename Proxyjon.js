javascript:(function() {
    ...
    function createMenu() {
        ...
        m.innerHTML = `
            <img src="https://i.ibb.co/RTGv2xP/Proxy-sha-256-20241021-142907-0000.jpg" style="display: block; margin: 0 auto; width: 100px; height: 100px; border-radius: 50%; border: 2px solid #00BFFF;"> <!-- Tamanho da imagem aumentado -->
