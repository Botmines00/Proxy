javascript:(function() {
    ...
    function createMenu() {
        ...
        Object.assign(m.style, {
            position: 'fixed', top: '30%', left: '30%', width: '450px',  // Largura maior para acomodar o layout horizontal
        ...
        m.innerHTML = `
            <img src="https://i.ibb.co/6r4yRDT/Proxy-sha-256-20241010-125036-0000.jpg" style="width: 80px; height: 80px; border-radius: 50%; border: 2px solid #fe5f2f; margin-right: 20px;"> <!-- Imagem ajustada -->
            <div style="flex: 1;">
                <h3 style='margin: 0; padding: 0; font-size: 20px;'>New System 00 <i class="fas fa-check-circle" style="color: #fe5f2f;"></i></h3>
